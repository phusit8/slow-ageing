    ...
    <div className="flex flex-col min-h-screen w-full justify-between " style={{ background: "#f5f7f5" }}>
      <div className="w-full max-w-md sm:max-w-lg mx-auto flex-1 flex flex-col justify-between">
        <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-8 pt-8 sm:pt-12">
          <div className="w-28 h-28 rounded-3xl flex items-center justify-center mb-6 shadow-lg" style={{ background: "linear-gradient(135deg,#2d7a3a,#4caf50)", }}>
            <Icon icon="mdi:heart-pulse" style={{ color: "white", fontSize: "60px" }} />
          </div>
          <h1 className="text-3xl font-bold text-center mb-1" style={{ color: "#1a2e1a" }}>Slow Aging</h1>
          <p className="text-base text-center mb-2" style={{ color: "#6b7b6b" }}>ระบบดูแลสุขภาพผู้สูงอายุ</p>
          <p className="text-sm " style={{ color: "#9aada9" }}>จังหวัดมหาสารคาม</p>
